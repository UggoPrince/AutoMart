...
function (_Validator) {
  ...
  function ValidateOrder() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ValidateOrder).call(this));
  }

  _createClass(ValidateOrder, [{
    key: "validateMakeOrderFields",
    value: function validateMakeOrderFields(buyer, carId, amount) {
